...
### Requirement: User-Conversation Relationship

The User model SHALL have a one-to-many relationship with conversations.
...
### Requirement: Conversation Deletion Cascading

When a user is deleted, all their conversations SHALL be deleted.

#### Scenario: Delete user with conversations
...
- **AND** no orphaned conversation or message records SHALL remain
